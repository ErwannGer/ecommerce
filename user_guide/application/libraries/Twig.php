...
class Twig {
    ...
    $this->_twig_env->addFunction('css_url', new Twig_Function_Function('css_url'));
    $this->_twig_env->addFunction('js_url', new Twig_Function_Function('js_url'));
    $this->_twig_env->addFunction('img_url', new Twig_Function_Function('img_url'));
